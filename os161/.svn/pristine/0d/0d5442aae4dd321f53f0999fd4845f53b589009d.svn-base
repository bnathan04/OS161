...
struct lock {
	...
	volatile int locked; // 1 = HIGH => the lock is being used 
	volatile struct thread* lock_holder; //name of thread that holds the lock
...
struct cv {
	...
	//Balu - October 8/2017
	volatile struct queue* wait_q; //threads waiting for this cv
